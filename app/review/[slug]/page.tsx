...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!r) return {};
  const url = `https://gaiheki-nuriekae-navi.com/review/${r.slug}/`;
  return {
    title: r.title,
    ...
    "@graph": [
      {
        ...
        headline: r.title,
        description: r.metaDescription,
        image: `https://gaiheki-nuriekae-navi.com${r.heroImage}`,
        dateModified: "2026-06-16",
        author: { "@type": "Organization", name: "外壁ぬりかえナビ" },
        publisher: { "@type": "Organization", name: "外壁ぬりかえナビ", url: "https://gaiheki-nuriekae-navi.com/" },
        mainEntityOfPage: `https://gaiheki-nuriekae-navi.com/review/${r.slug}/`,
      },
      {
        "@type": "FAQPage",
      ...
      <section id="reviews" className="scroll-mt-20 mb-12">
        ...
        <figure className="mt-8">
          <img src={r.subImage} alt={r.subAlt} width={1200} height={630}
            className="w-full rounded-2xl border border-border object-cover aspect-[1200/630]" />
          <figcaption className="mt-2 text-xs text-text-muted text-center">外壁塗装は塗料（シリコン・フッ素・無機等）や下地の状態によって耐用年数や費用が異なります。</figcaption>
        </figure>
      </section>
